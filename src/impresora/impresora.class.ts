    ...
    try {
      ...
      device.open(function() {
        printer
            ...
            .text('')
            .text('')
            .text('       0.01 --> ' +detalleApertura[0]['valor'].toFixed(3) +'      ' + '0.01 --> ' +detalleCierre[0]['valor'].toFixed(3) )
            .text('       0.02 --> ' +detalleApertura[1]['valor'].toFixed(3) +'      ' + '0.02 --> ' +detalleCierre[1]['valor'].toFixed(3) )
            .text('       0.05 --> ' +detalleApertura[2]['valor'].toFixed(3) +'      ' + '0.05 --> ' +detalleCierre[2]['valor'].toFixed(3) )
            .text('       0.10 --> ' +detalleApertura[3]['valor'].toFixed(3) +'      ' + '0.10 --> ' +detalleCierre[3]['valor'].toFixed(3) )
            .text('       0.20 --> ' +detalleApertura[4]['valor'].toFixed(3) +'      ' + '0.20 --> ' +detalleCierre[4]['valor'].toFixed(3) )
            .text('       0.50 --> ' +detalleApertura[5]['valor'].toFixed(3) +'      ' + '0.50 --> ' +detalleCierre[5]['valor'].toFixed(3) )
            .text('       1.00 --> ' +detalleApertura[6]['valor'].toFixed(3) +'      ' + '1.00 --> ' +detalleCierre[6]['valor'].toFixed(3) )
            .text('       2.00 --> ' +detalleApertura[7]['valor'].toFixed(3) +'      ' + '2.00 --> ' +detalleCierre[7]['valor'].toFixed(3) )
            .text('       5.00 --> ' +detalleApertura[8]['valor'].toFixed(3) +'      ' + '5.00 --> ' +detalleCierre[8]['valor'].toFixed(3) )
            .text('       10.00 --> ' +detalleApertura[9]['valor'].toFixed(3) +'     ' + '10.00 --> ' +detalleCierre[9]['valor'].toFixed(3) )
            .text('       20.00 --> ' +detalleApertura[10]['valor'].toFixed(3) +'    ' + '20.00 --> ' +detalleCierre[10]['valor'].toFixed(3) )
            .text('       50.00 --> ' +detalleApertura[11]['valor'].toFixed(3) +'    ' + '50.00 --> ' +detalleCierre[11]['valor'].toFixed(3) )
            .text('       100.00 --> ' +detalleApertura[12]['valor'].toFixed(3) +'   ' + '100.00 --> ' +detalleCierre[12]['valor'].toFixed(3) )
            .text('       200.00 --> ' +detalleApertura[13]['valor'].toFixed(3) +'   ' + '200.00 --> ' +detalleCierre[13]['valor'].toFixed(3) )
            .text('       500.00 --> ' +detalleApertura[14]['valor'].toFixed(3) +'   ' + '500.00 --> ' +detalleCierre[14]['valor'].toFixed(3) )
            .text('')
            .text('')
            .text('')
            .cut()
